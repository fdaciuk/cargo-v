...
pub fn update_version(cargo_toml_content: String, version: String) -> String {
  ...
  let new_version_number = string_version_to_number(&version);
  ...
  cargo_toml_content.replace(&current_version_string, &version)
}
...
mod tests {
  ...
  fn should_update_major_version_by_hand() {
    let cargo_toml =
      String::from("[package]\n name = \"cargo-v\"\n version = \"2.1.8\"\n");
    let new_version = String::from("3.0.0");
    let expected =
      String::from("[package]\n name = \"cargo-v\"\n version = \"3.0.0\"\n");
  ...
  fn should_accept_v_char_in_front_of_version() {
    let cargo_toml =
      String::from("[package]\n name = \"cargo-v\"\n version = \"2.1.8\"\n");
    let new_version = String::from("v3.0.0");
    let expected =
      String::from("[package]\n name = \"cargo-v\"\n version = \"3.0.0\"\n");
  ...
  fn should_not_set_a_new_version_lower_than_current_version() {
    let cargo_toml =
      String::from("[package]\n name = \"cargo-v\"\n version = \"2.2.0\"\n");
    let new_version = String::from("2.1.1");
  ...
  fn should_not_allow_set_a_negative_version() {
    let cargo_toml =
      String::from("[package]\n name = \"cargo-v\"\n version = \"2.2.0\"\n");
    let new_version = String::from("-2.2.1");
    update_version(cargo_toml, new_version);
  }
}
